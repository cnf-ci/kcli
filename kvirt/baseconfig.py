...
class Kbaseconfig:
    ...
    def __init__(self, client=None, containerclient=None, debug=False, quiet=False, offline=False):
        ...
        self.cpuflags = options.get('cpuflags', self.default['cpuflags'])
        self.cpupinning = options.get('cpupinning', self.default['cpupinning'])
        self.numamode = options.get('numamode', self.default['numamode'])
        self.numa = options.get('numa', self.default['numa'])
